public class Commands {
	...
	public static boolean testmoveplayer(int x[], int y[], Player a, Player b, int j) {
	...
	public static boolean testmove(int[] movesa, int[] movesb, Player a, Player b, int i) {
		return (testmoveplayer(movesa, movesb, a, b, i) && Commands.testwall(movesa, a, i) && Commands.testmovespace(movesa, movesb, a, b, i));	 
	}
	
	// Tests for Player Attack
	public static boolean testattack(int[] movesa, int[] movesb, Player a, Player b, int i) {
		boolean attacking = testattacking(movesa, movesb, a, b, i);
		return Commands.testattackconnect(movesa, a, b, attacking, i) || Commands.testmoveattack(movesa, movesb, a, b, attacking, i);	 
	}
