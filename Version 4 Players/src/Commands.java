public class Commands {
	...
	// Print Board
	public static String[][] printboard(Player a, Player b, Player c, Player d) {
	...
	public static boolean testmoveplayer(int x[], int y[], Player a, Player b,
		...
		if (x[j] == 1
				&& (y[j] != 1 || (y[j] == 1 && b.direction == (a.direction + 180) % 360))) {
	...
	public static boolean testattackconnect(int x[], Player a, Player b,
			boolean attacking, int j) {
	...
	public static boolean testmove(int[] movesa, int[] movesb, Player a,
			Player b, int i) {
		return (testmoveplayer(movesa, movesb, a, b, i)
				&& Commands.testwall(movesa, a, i) && Commands.testmovespace(
				movesa, movesb, a, b, i));
	}

	// Tests for Player Attack
	public static boolean testattack(int[] movesa, int[] movesb, Player a,
			Player b, int i) {
		boolean attacking = testattacking(movesa, movesb, a, b, i);
		return Commands.testattackconnect(movesa, a, b, attacking, i)
				|| Commands.testmoveattack(movesa, movesb, a, b, attacking, i);
	}
